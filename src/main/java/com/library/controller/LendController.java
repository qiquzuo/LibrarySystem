...
public class LendController {
    ...
    @RequestMapping("/deletebook.html")     //删除书籍页面
    ...
    @RequestMapping("/lendlist.html")          //借书页面
    ...
    @RequestMapping("/mylend.html")          //我的借书页面
    ...
    @RequestMapping("/deletelend.html")          //删除借书页面
    ...
    @RequestMapping("/lendbook.html")          //借书页面

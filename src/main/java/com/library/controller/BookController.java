...
public class BookController {
    ...
    @RequestMapping("/querybook.html")   //请求映射   查询书籍
    ...
    @RequestMapping("/admin_books.html")   //图书管理——>全部图书页面
    ...
    @RequestMapping("/book_add.html")    //图书管理——>增加图书页面
    ...
    @RequestMapping("/updatebook.html")//编辑书籍页面
    ...
    @RequestMapping("/admin_book_detail.html")   //书籍详情页
